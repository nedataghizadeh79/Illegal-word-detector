...
test3 = (
    [
        'نخهعغف خعهغیقس گهکعغعفقفیقس عغفقثتسثست قیفبلتا تمهعغفقبیذدزتنخک ۷قبفلغاتهنخ۰ح۹۸ک۷فمق۶نغ هحغفیقطبلذادا تعحعغ۸ف۷ق۶غ۵ثفسبلا ۰۹۸۷۶۵ثف فغففغیقذلادزاتنتتزاز ۷فغل ات خحمن',
